...
**[U.S. National Institute of Health](https://www.nih.gov/){:target="_blank"}** (NIH), contracted through **[Axle Informatics](https://axleinfo.com/){:target="_blank"}, MD, USA**	<br>
_Bioinformatics Scientist_ - [National Institute of Allergy and Infectious Diseases](https://www.niaid.nih.gov/){:target="_blank"} (NIAID) (2022 - 2025) <br>
  - Member of the [Integrated Data Sciences Section](https://www.niaid.nih.gov/research/research-technologies-branch-integrated-data-sciences){:target="_blank"}, which provides data analysis and experimental design for NGS experiments conducted by clinical researchers at NIAID and other institutes within NIH.
  - Supported 20 bioinformatics analysis projects across 15 research teams, developing workflows to analyze large datasets for bulk and single-cell RNA-seq, CITE-seq, TCR-seq, whole genome sequencing and metagenomics, using R, Python, Snakemake, and SLURM-based HPC systems 
  - Coauthored and contributed to peer-reviewed scientific publications (1 published, 4 in process) and conference presentations, and in support of a pilot clinical study, resulting in NIH institutional review board approval for a large-scale trial
  - Analyzed data from a wide range of sequencing technologies: Illumina, Pac-Bio, 10x Genomics, Oxford Nanopore through standardized and custom analysis pipelines for analyzing NGS data
  - Implemented nf-core nextflow pipeline for analysis of CUT&Tag, ChIP-seq, and TCR-seq data, and contributed to the [OpenOmics Github](https://github.com/OpenOmics){:target="_blank"}. 
  - Demonstrated effective project management and stakeholder engagement through on-time deliveries for up to seven concurrent projects with customers from diverse multicultural backgrounds
